          ...
          {survey.radio &&
            survey.radio.map(currentRadio =>
              <div key={currentRadio._id} className="preview-group">
                ...
                <input className="preview-input" type="radio" id={currentRadio.a1[0]._id} name={"radio-" + currentRadio._id} />
                <label className="preview-label" htmlFor={currentRadio.a1[0]._id}>{currentRadio.a1[0].content}</label><br />
                <input className="preview-input" type="radio" id={currentRadio.a2[0]._id} name={"radio-" + currentRadio._id} />
                ...
                {currentRadio.a3[0] &&
                  <div>
                    <input className="preview-input" type="radio" id={currentRadio.a3[0]._id} name={"radio-" + currentRadio._id} />
                    <label className="preview-label" htmlFor={currentRadio.a3[0]._id}>{currentRadio.a3[0].content}</label><br />
                  </div>
                }
                {currentRadio.a4[0] &&
                  <div>
                    <input className="preview-input" type="radio" id={currentRadio.a4[0]._id} name={"radio-" + currentRadio._id} />
                    <label className="preview-label" htmlFor={currentRadio.a4[0]._id}>{currentRadio.a4[0].content}</label><br />
                  </div>
                }
                {currentRadio.a5[0] &&
                  <div>
                    <input className="preview-input" type="radio" id={currentRadio.a5[0]._id} name={"radio-" + currentRadio._id} />
          ...
          {survey.checkbox &&
            survey.checkbox.map(currentCheckbox =>
              <div key={currentCheckbox._id} className="preview-group">
                ...
                <input className="preview-input" type="checkbox" id={currentCheckbox.a1[0]._id} name={"checkbox-" + currentCheckbox._id} />
                <label className="preview-label" htmlFor={currentCheckbox.a1[0]._id}>{currentCheckbox.a1[0].content}</label><br />
                <input className="preview-input" type="checkbox" id={currentCheckbox.a2[0]._id} name={"checkbox-" + currentCheckbox._id} />
                <label className="preview-label" htmlFor={currentCheckbox.a2[0]._id}>{currentCheckbox.a2[0].content}</label><br />
                {/* check for third through fifth answer choices */}
                {currentCheckbox.a3[0] &&
                  <div>
                    <input className="preview-input" type="checkbox" id={currentCheckbox.a3[0]._id} name={"checkbox-" + currentCheckbox._id} />
                    <label className="preview-label" htmlFor={currentCheckbox.a3[0]._id}>{currentCheckbox.a3[0].content}</label><br />
                  </div>
                }
                {currentCheckbox.a4[0] &&
                  <div>
                    <input className="preview-input" type="checkbox" id={currentCheckbox.a4[0]._id} name={"checkbox-" + currentCheckbox._id} />
                    <label className="preview-label" htmlFor={currentCheckbox.a4[0]._id}>{currentCheckbox.a4[0].content}</label><br />
                  </div>
                }
                {currentCheckbox.a5[0] &&
                  <div>
                    <input className="preview-input" type="checkbox" id={currentCheckbox.a5[0]._id} name={"checkbox-" + currentCheckbox._id} />
          ...
          {survey.text &&
            survey.text.map(currentText =>
              <div key={currentText._id} className="preview-group">
                ...
                <input type="text" id={currentText._id} name={"text-" + currentText._id} className="answer" />
              </div>
            )}
          ...
          {survey.textArea &&
            survey.textArea.map(currentTextArea =>
              <div key={currentTextArea._id} className="preview-group">
                ...
                <textarea rows="4" cols="50" id={currentTextArea._id} name={"textarea-" + currentTextArea._id} className="answer" />
              </div>
            )}
            ...
            survey.likert.map(currentLikert =>
              <div key={currentLikert._id} className="preview-group">
                ...
                <div>
                  ...
                  <input type="range" name={"likert-" + currentLikert._id} min="1" max="5" />
                </div>
              </div>
            )}
        </div>
        <input type="submit" value="submit survey" className="btn center" />
      </form>
    </div>
  )
}
